...
// Define a simple message for requests
...
// Define a simple message for responses
...
const file_users_proto_rawDesc = "" +
	...
	"\aGreeter\x12)\n" +
	"\bSayHello\x12\r.HelloRequest\x1a\x0e.HelloResponseB\rZ\va.mypackageb\x06proto3"
