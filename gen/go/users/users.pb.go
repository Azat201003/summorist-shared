...
type SignInRequest struct {
	...
	Password      []byte                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty" gorm:"type:bytea"`
...
const file_users_users_proto_rawDesc = "" +
	"\n" +
	"\x11users/users.proto\x12\x05users\x1a\x13tagger/tagger.proto\"_\n" +
	"\rSignInRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x122\n" +
	"\bpassword\x18\x02 \x01(\fB\x16\x9a\x84\x9e\x03\x11gorm:\"type:bytea\"R\bpassword\"f\n" +
